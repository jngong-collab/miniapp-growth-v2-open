...
exports.main = async (event = {}) => {
  ...
  switch (action) {
    ...
    case 'catalog.deletePackage':
      return withAdmin('manageProducts', access => catalogModule.deletePackage(access, event))
    ...
    case 'settings.generateImage':
      return withAdmin('manageProducts', access => settingsModule.generateImage(access, event))
